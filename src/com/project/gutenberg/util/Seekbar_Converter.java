...
public class Seekbar_Converter {
    public static int convert_font_scale_to_seekbar_position(float scale) {
    ...
    public static float convert_seekbar_position_to_font_scale(int position) {
    ...
    public static String convert_seekbar_position_to_label(int position) {
